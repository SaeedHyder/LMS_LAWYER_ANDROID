...
public class Lawyer implements Serializable {
    ...
    @Expose
    private List<String> resumeDocuments = null;
    @SerializedName("user_docs")
    @Expose
    private List<UserDoc> userDocs = null;
    ...
    public Object getAvgRate() {
        return avgRate;
    }

    public void setAvgRate(Object avgRate) {
    ...
    public List<String> getResumeDocuments() {
        return resumeDocuments;
    }

    public void setResumeDocuments(List<String> resumeDocuments) {
