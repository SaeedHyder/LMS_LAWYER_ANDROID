...
public class TagEditText extends EditText {
    ...
    private void format() {
        ...
        for (int i = 0; i < strings.length; i++) {
            ...
            ClickableSpan myClickableSpan = new ClickableSpan(startIdx, endIdx);
    ...
    public View createTokenView(String text) {
        ...
        parentLayout.setBackgroundResource(R.drawable.bordered_rectangle_rounded_corners);
        ...
        imageView.setImageResource(R.drawable.icn_cross);
