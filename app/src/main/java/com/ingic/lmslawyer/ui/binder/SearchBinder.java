...
public class SearchBinder extends CustomRecyclerViewBinder<SubCategory> {
    private DockActivity dockActivity;
    private BasePreferenceHelper prefHelper;
    private ImageLoader imageLoader;
    private CaterogyClickListner clickListner;

    public SearchBinder(DockActivity dockActivity, BasePreferenceHelper prefHelper, CaterogyClickListner clickListner) {
