...
import com.ingic.lmslawyer.util.BitmapUtil;
import com.ingic.lmslawyer.util.PixelUtil;
...
public class RangeSeekBar<T extends Number> extends ImageView {
    ...
    public static final int TEXT_LATERAL_PADDING_IN_DP = 20;
    ...
    private void init(Context context, AttributeSet attrs) {
        float barHeight;
        int thumbNormal = R.drawable.range_thumb;
        int thumbPressed = R.drawable.range_thumb;
        int thumbDisabled = R.drawable.range_thumb;
        ...
        rect = new RectF(padding, 0.5f * (getHeight() - 2), getWidth() - padding, 0.5f * (getHeight() + 2));
    ...
    private String numberWithCommas(String x) {
        String num = NumberFormat.getNumberInstance(Locale.US).format(Double.parseDouble(x));
        return num;
    }
     ...
     */
    private void setNormalizedMinValue(double value, boolean isMin) {
//        if (isMin){
//            normalizedMinValue = Math.max(0d, Math.min(.6d, Math.min(value, normalizedMaxValue)));
//
//        }
//        else{
//
...
//        BaseFragment
//        loadingStarted();
//        Call<ResponseWrapper<countwraper>> call = webService.getmaxcarvalue();
//        call.enqueue(new Callback<ResponseWrapper<countwraper>>() {
//            @Override
//            public void onResponse(Call<ResponseWrapper<countwraper>> call, Response<ResponseWrapper<countwraper>> response) {
//                if (response.body().getResponse().equals(AppConstants.CODE_SUCCESS)) {
//                    priceSeekBar.setRangeValues(0,Integer.parseInt(response.body().getResult().getMax_value()));
//                }
//                loadingFinished();
//            }
//
//            @Override
//            public void onFailure(Call<ResponseWrapper<countwraper>> call, Throwable t) {
//                loadingFinished();
//            }
//        });
//    }
