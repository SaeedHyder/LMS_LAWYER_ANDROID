package com.ingic.lmslawyer.ui.adapters.abstracts;
...
public abstract class MatchableRVArrayAdapter<T> extends RecyclerView.Adapter<MatchableRVArrayAdapter.RecyclerviewViewHolder>
    ...
    private List<T> tempList = Collections.emptyList();
    private Context mContext;
    private OnViewHolderClick originalListener;
    private OnDataChange onDataChange;


    public MatchableRVArrayAdapter(Context context) {
        this(context, null, null ,null);
    }

    public MatchableRVArrayAdapter(Context context, OnViewHolderClick listener, Function<T, String> converter,
...
//            tempList = (List<T>) results.values;
            onDataChange.update(results.count);
            notifyDataSetChanged();
